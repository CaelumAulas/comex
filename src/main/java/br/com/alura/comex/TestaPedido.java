...
public class TestaPedido {
    ...
    public static void main(String[] args) {
        ...
        Produto produto1 = new Produto("Produto 1", "Descrição do Produto 1", 100.0F, 10);
        Produto produto2 = new Produto("Produto 2", "Descrição do Produto 2", 200.0F, 20);
        Produto produto3 = new Produto("Produto 3", "Descrição do Produto 3", 300.0F, 30);
